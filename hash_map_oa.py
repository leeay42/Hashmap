...
class HashMap:
    ...
    def put(self, key: str, value: object) -> None:
        ...
        initial_index_val = index_val
        quad = 1

        while self._buckets[index_val] is not None:
            # position is tombstone, replace with new entry
            if self._buckets[index_val].is_tombstone is True:
                self._buckets[index_val] = new_entry
                self._size += 1
                return
            # key exists at position, change value
            if self._buckets[index_val].key == key:
                self._buckets[index_val].value = value
                return
            # collision, initiate quadratic probing
            index_val = (initial_index_val + quad ** 2) % self._capacity
            quad += 1

        # empty position, new entry
        self._buckets[index_val] = new_entry
        self._size += 1
    ...
    def resize_table(self, new_capacity: int) -> None:
        ...
        """
        # if new_capacity is less than current number of elements in hash map, leave method
    ...
    def get(self, key: str) -> object:
        ...
        while self._buckets[index_val] is not None:
            # key at position and is not tombstone, return value
            if self._buckets[index_val].key == key and self._buckets[index_val].is_tombstone is False:
    ...
    def contains_key(self, key: str) -> bool:
        ...
        while self._buckets[index_val] is not None:
            # key at position and is not tombstone
            if self._buckets[index_val].key == key and self._buckets[index_val].is_tombstone is False:
                return True
            # collision, initiate quadratic probing
            index_val = (initial_index_val + quad ** 2) % self._capacity
    ...
    def remove(self, key: str) -> None:
        ...
        while self._buckets[index_val] is not None:
            # key at position and is not tombstone, "remove"
            if self._buckets[index_val].key == key and self._buckets[index_val].is_tombstone is False:
    ...
    def get_keys_and_values(self) -> DynamicArray:
        ...
        for index in range(self._capacity):
            ...
            if self._buckets[index] is not None and self._buckets[index].is_tombstone is False:
                ...
                new_da.append((self._buckets[index].key, self._buckets[index].value))
    ...
    def __next__(self):
        ...
        iterator. Only iterates over active items.
        """
        try:
            value = None
            # return value at index when not None and not tombstone (active item)
